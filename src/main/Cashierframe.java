...
public class Cashierframe extends JFrame {
	...
	public Cashierframe() throws IOException {
		...
		mntmNewMenuItem.setIcon(new ImageIcon(Cashierframe.class.getResource("/main/logo/menu.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(Cashierframe.class.getResource("/main/logo/list.png")));
		...
		btnNewButton.setIcon(new ImageIcon(Cashierframe.class.getResource("/main/logo/neworder.png")));
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Cashierframe.class.getResource("/main/logo/logo.png")));
	}
}
